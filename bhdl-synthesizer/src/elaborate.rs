...
pub fn emit_elaborated_with_preamble(
    ...
    for inst in &insts {
        ...
        for (k, v) in &attrs {
            if k.starts_with("expansion_") || k.starts_with("vpin_") || k.starts_with("decap_") || k.starts_with("powertree_") || k.starts_with("composed_") || k.starts_with("stage_") || k.starts_with("pull_cfg__") || k.starts_with("mux__") || k.starts_with("internal_pull_model") || k.starts_with("pull_requirement") || k.as_str() == "gated_pins" || k.as_str() == "virtual_component" {
