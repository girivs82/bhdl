//! Verbose test for simple LED circuit

use anyhow::Result;
use bhdl_spice::{Circuit, ComponentModel, ElectricalLimits, GlacierSolver};

fn main() -> Result<()> {
    println!("=== Simple LED Circuit Test (Verbose) ===\n");
    ...
    match solver.analyze() {
        Ok(solutions) => {
            ...
            for (i, (start, end, gradient, result)) in solutions.iter().enumerate() {
                ...
                if error_percent < 50.0 {
                    println!("  ✓ This is a reasonable solution");
                } else {
                    println!("  ✗ This solution seems incorrect");
                }
        ...
        Err(e) => {
            ...
            println!("\nThis suggests a problem with the solver");
        }
    }
